...
const index: React.FC = () => {
  ...
  const getLatestVersion = () => {
    ...
    request.get(api.imageNotebook.version.latest).then((latestVersionRes) => {
      loading.close();
  ...
  return (
    <div className={classes.root}>
      ...
      <div className="page">
        <img className="logo" src="https://files.potatofield.cn/Static/ImageNotebook/preview-editor.webp" />
        <div className="title">洋芋田图笔记本</div>
        <div className="intro">一款以图片标记为核心的笔记本</div>
      ...
      <div className="page">
        ...
        <div className="actions">
          <Button
            onClick={() => history.push('/imagenotebook/about')}
            className="action"
            color="primary"
            size="large"
            variant="contained"
          ...
          <Button
            onClick={() => history.push('/imagenotebook/changelog')}
            className="action"
            color="primary"
            size="large"
            variant="contained"
